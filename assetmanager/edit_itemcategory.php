...
$query3=mysqli_query($conn,"update itemcategory set itemname='$name', itemdesc='$age' where itemid='$id'");
if(!$query3){
    echo "error";
}
else{
 ...
 $query1=mysqli_query($conn,"select * from itemcategory where itemid='$id'");
                  ...
                  <table id="datatable" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input type="text" name="itemcategory_name" id="itemcategory_name" class="form-control" value="<?php echo $query2['itemname'];?>" required/><input name="id" hidden value="<?php echo $id; ?>"></td>
                        </tr>
                        <tr>
                            <td align="style="justify"><strong >&nbsp;&nbsp;Item Category Description </strong></td>
                            <td><input type="text" name="itemcategory_Description" id="itemcategory_Description" class="form-control" value="<?php echo $query2['itemdesc']; ?>"/></td>
                        </tr>		
                    </tbody>
                  </table>		  
                </div> 
