                ...
                <div class="x_content">
                  ...
                  <table id="datatable" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        $res= "SELECT asset_type_id,asset_type_name,type_description FROM assettype";
                        ...
                        <tr class="success">
                            ...
                            if($result->num_rows > 0){
                                while($row= $result->fetch_assoc()){
                                    echo "<tr><td>".$row["asset_type_id"]."</td>"."<td>".$row["asset_type_name"]."</td>"."<td>".$row["type_description"]."</td>";
