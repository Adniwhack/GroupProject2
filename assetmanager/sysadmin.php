                ...
                <div class="features">
					...
					<div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <a href="reports.html"><div class="feature-wrap">
                            <i class="fa fa-eye"></i>
                            <h2>Adding asset clerk</h2>
                            <h3>add asset clerk to any department </h3>
                        </div>
						</a>
                    </div><!--/.col-md-4-->
					...
					<div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <a href="reports.html"><div class="feature-wrap">
                            <i class="fa fa-eye"></i>
                            <h2>Removing asset clerk</h2>
                            <h3>Remove asset clerk from the system</h3>
                        </div>
						</a>
                    </div><!--/.col-md-4-->
					...
					<div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <a href="reports.html"><div class="feature-wrap">
                            <i class="fa fa-eye"></i>
                            <h2>Updating asset clerk</h2>
                            <h3>Update the details of asset clerk, and transfer asset clerk to different departments</h3>
                        </div>
						</a>
                    </div><!--/.col-md-4-->
